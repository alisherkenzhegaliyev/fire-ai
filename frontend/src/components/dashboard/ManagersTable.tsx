  ...
  return (
    <div className="rounded-xl border border-gray-700/50 bg-gray-800/40 overflow-hidden">
      <div className="px-4 py-3 border-b border-gray-700/50">
        <p className="text-sm font-semibold text-white">Managers ({managers.length})</p>
      </div>
        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="border-b border-gray-700/50 text-xs text-gray-400 uppercase tracking-wider">
              ...
              <th className="px-4 py-2.5 text-left font-medium min-w-[140px]">Workload</th>
            </tr>
          </thead>
          <tbody>
            {managers.map((manager) => {
              ...
              return (
                <tr key={manager.id} className="border-b border-gray-700/30">
                  <td className="px-4 py-2.5 font-medium text-gray-200">{manager.fullName}</td>
                  ...
                  <td className="px-4 py-2.5">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-gray-400 w-6 text-right">{manager.workload}</span>
                    </div>
                  </td>
                </tr>
              )
